...
public enum StatusBarType implements StringRepresentable {
    ...
    StatusBarType(String id, BarPositioner.BarAnchor defaultAnchor, int defaultGridY,
                  Color[] colors, boolean hasOverflow, boolean hasMax,
                  @Nullable Color textColor, Component name) {
        this.id = id;
    ...
    public BarPositioner.BarAnchor getDefaultAnchor() { return defaultAnchor; }
    public int getDefaultGridY() { return defaultGridY; }
    public Color[] getColors() { return colors; }
    public boolean hasOverflow() { return hasOverflow; }
