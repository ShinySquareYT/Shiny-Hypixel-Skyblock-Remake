package net.shinysquare.shsbm.world;
 ...
 *   src/main/resources/data/shiny_sb/dimension/the_rift.json       (chunk generator + biome)
 *   src/main/resources/data/shiny_sb/dimension_type/the_rift.json  (light, sky, effects)
 *
...
public class ModDimensions {
    ...
    public static final ResourceKey<Level> THE_RIFT = ResourceKey.create(
            ...
            ResourceLocation.fromNamespaceAndPath(ShinyHypixelSBRemake.MOD_ID, "the_rift")
    );
